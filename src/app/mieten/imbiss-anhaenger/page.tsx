...
export const metadata: Metadata = {
  title: "Imbiss-Anhänger mieten | MINO",
  description: "Mietbare MINO Imbissanhänger für Events, Saisonbetrieb und flexible Einsätze.",
};

const filterGroups = [
  {
    title: "Verfügbarkeit",
    options: ["Mietbereit", "In Fertigung", "Reservierbar"],
  },
  {
  ...
  {
    title: "Mietpreis",
    options: ["bis 1.500 € / Monat", "1.500 - 2.500 € / Monat", "ab 2.500 € / Monat"],
  },
];
...
export default function ImbissAnhaengerMietenPage() {
  return (
    <>
      <Header />
