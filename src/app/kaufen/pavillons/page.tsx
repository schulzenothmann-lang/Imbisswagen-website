...
export const metadata: Metadata = {
  title: "Sofort verfügbare Verkaufs-Pavillons | MINO",
  description: "Günstige Verkaufs-Pavillons als kompakte Alternative zum Imbissanhänger.",
};
...
const filterGroups = [
  ...
  {
    title: "Preis",
    options: ["bis 10.000 €", "10.000 - 15.000 €", "ab 15.000 €"],
  },
];
...
export default function PavillonsKaufenPage() {
  return (
    <>
      <Header />
