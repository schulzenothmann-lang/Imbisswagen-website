...
export const translations = {
  ...
  pavilionPurchaseDescription: {
    de: "Verkaufspavillons als kompakte Alternative zum Anhänger.",
  ...
  pavilionRentalDescription: {
    de: "Verkaufspavillons für Märkte, Events und Tests.",
    en: "Sales pavilions for markets, events and testing.",
    fr: "Pavillons de vente pour marchés, événements et essais.",
  ...
  buyLandingIntro: {
    de: "Fertige Imbiss-Anhänger und Verkaufspavillons, die kurzfristig verfügbar sind.",
  ...
  rentLandingIntro: {
    de: "Mietbare Imbiss-Anhänger und Verkaufspavillons für Märkte, Events und saisonale Einsätze.",
    en: "Food trailers and sales pavilions to rent for markets, events and seasonal use.",
    fr: "Remorques snack et pavillons de vente à louer pour marchés, événements et saisons.",
    nl: "Foodtrailers en verkooppaviljoens te huur voor markten, events en seizoenen.",
  },
  pickTypeHeading: {
    de: "Anhänger oder Verkaufspavillon?",
    en: "Trailer or sales pavilion?",
    fr: "Remorque ou pavillon de vente ?",
    nl: "Trailer of verkooppaviljoen?",
  },
  configureEyebrow: {
    de: "Konfigurieren",
    en: "Configure",
  ...
  chooseConfigurator: {
    de: "Du startest bei der Auswahl zwischen Imbiss-Anhänger und Verkaufspavillon.",
    en: "You start by choosing between food trailer and sales pavilion.",
    fr: "Vous commencez par choisir entre remorque snack et pavillon de vente.",
    nl: "Je start met de keuze tussen foodtrailer en verkooppaviljoen.",
  },
  step: {
  ...
  choosePavilionSize: {
    de: "Wähle zuerst die Größe deines Verkaufspavillons. Öffnungen und Ausstattung legst du danach fest.",
    en: "First choose the size of your sales pavilion. Openings and equipment follow next.",
    fr: "Choisissez d'abord la taille de votre pavillon de vente. Les ouvertures et l'équipement suivront.",
    nl: "Kies eerst de maat van je verkooppaviljoen. Openingen en uitrusting volgen daarna.",
  },
  pavilionIntro: {
    de: "Der Verkaufspavillon ist die günstigere, modulare Alternative zum Anhänger. Wähle unten die passende Grundfläche für deinen Einsatz.",
    en: "The sales pavilion is the more affordable modular alternative to a trailer. Choose the right footprint below.",
    fr: "Le pavillon de vente est l'alternative modulaire plus économique à la remorque. Choisissez la surface adaptée.",
    nl: "Het verkooppaviljoen is het voordeligere modulaire alternatief voor een trailer. Kies hieronder de juiste oppervlakte.",
  },
  ...
  openingHint: {
    de: "Wähle, wie viele Seiten deines Verkaufspavillons offen sein sollen.",
    en: "Choose how many sides of your sales pavilion should be open.",
    fr: "Choisissez combien de côtés du pavillon de vente doivent être ouverts.",
